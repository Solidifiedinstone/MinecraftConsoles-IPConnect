...
LevelExitProgressStat1	Refers to the highest level performance metric for your game.  This is entirely up to you and will help us understand how well the player performed, or how far the player progressed in the level before exiting.
LevelExitProgressStat2	Refers to the highest level performance metric for your game.  This is entirely up to you and will help us understand how well the player performed, or how far the player progressed in the level before exiting.
LevelID	This is a more granular view of mode.
LevelInstanceID	Generated by the game every time LevelStart or LevelResume is called.
...
PlayerLevelUpProgressStat1	Refers to a performance metric for your player when they level or rank up.
PlayerLevelUpProgressStat2	Refers to a performance metric for your player when they level or rank up.
PlayerWeaponID	What weapon the player is holding or what approach/tact the player is taking to overcome a challenge
PlayspaceFeedbackWarningDirection	identifies which side of the playspace players are getting too close to
SaveOrCheckpointID	Unique save/checkpoint ID for stitching player experience.
